...
import 'package:muproject/view/screens/main.dart';

class DisplayProduct extends StatefulWidget {
  DisplayProduct({super.key});
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        ProductSizeBoxes(
                            mediaQuery: mediaQuery,
                            textSize: 'M',
                            boxColor: Color(0xff111260).withOpacity(.1)),
                        ProductSizeBoxes(
                            mediaQuery: mediaQuery,
                            textSize: 'L',
                            boxColor: Color(0xffF5F6FA)),
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                                fontSize: 15,
                                fontWeight: FontWeight.bold,
                                color: Color(0xff111260).withOpacity(.6)),
                          ),
                          SizedBox(
                            height: 10,
                          ),
                          Text(
                            'Eat Lovers is filled with toppings of sliced ​​beef sausage, minced beef, beef burger, and chicken sausage. In one biteeat Lovers is filled with toppings of sliced ​​beef sausage, minced beef, beef burger, and chicken sausage. In one bite, you can taste a variety of processed meats that are many and dense. Especially the minced meat which still has fiber in it.This pizza is very tasty. you can buy it in very cheap prices.order now otherwise someone else buy it.Meat Lovers is filled with toppings of sliced ​​beef sausage, minced beef, beef burger, and chicken sausagMeat Lovers is filled with toppings of sliced ​​beef sausage, minced beef, beef burger, and chicken sausage. In one bite, you can taste a variety of processed meats that are many and dense. Especially the minced meat which still has fiber in it.This pizza is very tasty. you can buy it in very cheap prices.order now otherwise someone else buy it.Meat Lovers is filled with toppings of sliced ​​beef sausage, minced beef, beef burger, and chicken sausage.eat Lovers is filled with toppings of sliced ​​beef sausage, minced beef, beef burger, and chicken sausage. In one bite, you can taste a variety of processed meats that are many and dense. Especially the minced meat which still has fiber in it.This pizza is very tasty. you can buy it in very cheap prices.order now otherwise someone else buy it.Meat Lovers is filled with toppings of sliced ​​beef sausage, minced beef, beef burger, and chicken sausag.',
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Row(
                          ...
                          children: [
                            Image.asset(
                              'assets/images/🦆 icon _share android_.png',
                              height: 33,
                            ),
                            SizedBox(
                              width: 7,
