...
import 'package:muproject/view/screens/welcome3.dart';
class Welcome2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          child: Center(
                            child: Text(
                              'Get started',
                              style: TextStyle(fontSize: 15, color: Color(0xff030303)),
                            ),
                          ),
                          style: ButtonStyle(
    ...
    backgroundColor: MaterialStateProperty.all<Color>(Color(0xffC0E862)),
                      ...
                      ElevatedButton(
                        ...
                        child: Center(
                          child: Text(
                            'Get started',
                            style: TextStyle(
                                fontSize: 15, color: Color(0xff030303)),
                          ),
                        ),
                        style: ButtonStyle(
